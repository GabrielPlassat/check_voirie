...
HORS_PERIMETRE_INFRA = [
    ...
    # Contournements et echangeurs hors agglomeration
    r'\bcontournement\b.{0,20}\b(nord|sud|est|ouest)\b', r'\bechangeur\b',
]
# RD et RN en traversee d agglomeration = voies urbaines → L228-2 s'applique
KEYWORDS_CYCLABLE = [
...
| Objet contient : autoroute, voie rapide, pont/viaduc sur RN/RD, échangeur, contournement | **−3** |
| ⚠️ Routes dép. ou nat. **en agglomération** → restent dans le périmètre (L228-2 s'applique) | — |
